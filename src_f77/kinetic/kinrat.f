...
C-----------------------------------------------------------------------
      ...
      write(6,*) 'KINRAT: iph,ith,m,l,nelk = ',iph,ith,m,l,nelk
...
c$$$      APHASE = 0.0
c$$$      DO I=1,3
c$$$         APHASE = APHASE + PRAY(I,K,L,M)**2
c$$$      ENDDO
c$$$      APHASE = 1.0/SQRT(APHASE)
c$$$
c$$$      DO I=1,3
c$$$         UNORM(I) = APHASE*PRAY(I,K,L,M)
c$$$      ENDDO
c$$$
c$$$      WRITE(6,*) '   + CALL KINZRO (2nd):'
c$$$      CALL KINZRO(UNORM,KMODE,XRAY(1,K,L,M),
c$$$     +            P0,VPHASE,GN,GVEC,KASINO,
c$$$     +            ELK4,NX,NY,NZ,NELK,DXGRI4,X0GRI4,
c$$$     +            NPOLX,NPOLY,NPOLZ,CA4,DA4,NPXYZ,IERR)
c$$$
c$$$      WRITE(6,*) '     - VPHASE = ',VPHASE
c$$$      WRITE(6,*) '     - APHASE = ',APHASE
